...
class DataFactory:
    ...
    def __get_imagenet_tiny(self, config, kwargs):
        train_loader = torch.utils.data.DataLoader(
            datasets.ImageFolder(root="./data/imagenet_tiny/train", transform=transforms.Compose(
                [
        ...
        test_loader = torch.utils.data.DataLoader(
            datasets.ImageFolder(root="./data/imagenet_tiny/val", transform=transforms.Compose([
    ...
    def __get_imagenet_full(self, config, kwargs):
        train_loader = torch.utils.data.DataLoader(
            datasets.ImageFolder(root="./data/imagenet_full/train", transform=transforms.Compose(
                [
                    transforms.RandomResizedCrop(224),
                    transforms.RandomHorizontalFlip(),
                    transforms.ToTensor(),
        ...
        test_loader = torch.utils.data.DataLoader(
            datasets.ImageFolder(root="./data/imagenet_full/val", transform=transforms.Compose([
                transforms.Resize(256),
                transforms.CenterCrop(224),
                transforms.ToTensor(),
                transforms.Normalize((0.485, 0.456, 0.406), (0.229, 0.224, 0.225))
